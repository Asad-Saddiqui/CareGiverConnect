                ...
                <div class="d-flex justify-content-center align-items-center">
                        ...
                        <div class="col-lg-5 col-md-6 border d-flex justify-content-center align-items-center ">
                            ...
                            ?>
                                ...
                                if($rows===1){
?>
                                        <div class="mb-1 text-capitalize"><b>Experience:</b> <?php echo $rowprofile['exprience']; ?></div>
                                        <div class="mb-1 text-capitalize"><b>Contact:</b> <?php echo $rowprofile['phone']; ?></div>
                                        <div class="mb-1 text-capitalize"><b>Experience:</b> <?php echo $rowprofile['exprience']; ?></div>
                                        <div class="mb-1 text-capitalize"><b>Address:</b> <?php echo $rowprofile['location']; ?></div>
                                        <div class="mb-1 text-capitalize"><b>Services:</b> <?php echo $rowprofile['Service']; ?></div>
